			...
			<div class="row text-center text-md-left mt-3 pb-3">
				<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
					<h6 align="center" class="text-uppercase mb-4 font-weight-bold"
						style="line-height: 3px">UTN FRRO</h6>
				...
				<div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
					...
					<p align="center">
						<svg style="margin-bottom: 5px" width="1em" height="1em"
              ...
              <path fill-rule="evenodd"
					...
					<p align="center">
						<svg style="margin-bottom: 2px" width="1em" height="1em"
              ...
              <path fill-rule="evenodd"
					...
					<p align="center">
						<svg style="margin-bottom: 4px" width="1em" height="1em"
							viewBox="0 0 16 16" class="bi bi-telephone-fill"
							fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
