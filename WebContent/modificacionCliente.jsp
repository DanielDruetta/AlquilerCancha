			...
			<div class="row">
				<div class="col-md-6">
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputUsuario" name="usuario" class="form-control" type="text" value=<%=c.getUsuario()%> disabled>
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputPassword" name="contrasena" class="form-control" type="password" value=<%=c.getPassword()%> disabled>
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputNombre" name="nombre" class="form-control" type="text" value=<%=c.getNombre()%> disabled>
					    </div>
				    </div>
				   	...
				   	<div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputApellido" name="apellido" class="form-control" type="text" value=<%=c.getApellido()%> disabled >
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputEmail" name="email" class="form-control" type="email" value=<%=c.getEmail()%> disabled>
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputCelular" name="celular" class="form-control" type="number" value=<%=c.getCelular()%> disabled >
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-md-12">
					    <input id="inputDni" name="dni" class="form-control" type="number" value=<%=c.getDni()%> disabled >
					    </div>
				    </div>
		        ...
		        <div class="col-md-6">
				    ...
				    <div class="form-group">
					    <label for="inputPassword" class="control-label col-md-2">Password:</label>
					    <div class="col-md-12">
					    <input id="inputPassword" name="contrasena" class="form-control" type="password">
					    </div>
				    </div>
				    ...
				    <div class="form-group">
					    <label for="inputCelular" class="control-label col-md-2">Celular:</label>
					    <div class="col-md-12">
					    <input id="inputCelular" name="celular" class="form-control" type="number" placeholder="" >
					    </div>
				    </div>
