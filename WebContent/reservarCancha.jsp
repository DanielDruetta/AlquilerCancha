...
<body>
	<nav class="site-header sticky-top py-1">
		<div
			...
			<a class="py-2" href="menuCliente.html"> <svg
			...
			</a> <a class="py-2 d-none d-md-inline-block" href="reservarCancha.jsp">Reservar
				cancha</a> <a class="py-2 d-none d-md-inline-block"
				href="cancelarCancha.jsp">Cancelar reserva</a> <a
				class="py-2 d-none d-md-inline-block" href="#">Buscar partido</a> <a
				class="py-2 d-none d-md-inline-block" href="modificacionCliente.jsp">Modificar
				datos personales</a> <a class="py-2 d-none d-md-inline-block" href="#">Support</a>
			<a class="py-2 d-none d-md-inline-block" href="#">Pricing</a> <a
