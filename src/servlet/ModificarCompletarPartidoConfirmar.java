...
public class ModificarCompletarPartidoConfirmar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out
				.println("La cantidad jugadores actuales que esta necesitando la reserva: " + cant_jugadores_vieja_int);
		int nueva_cantidad_jugadores_necesitados = cant_jugadores_aportados_int + cant_jugadores_vieja_int
				- cant_jugadores_nueva_int;
		System.out.println(
				"La nueva cantidad de jugadores necesitados de la reserva es: " + nueva_cantidad_jugadores_necesitados);
