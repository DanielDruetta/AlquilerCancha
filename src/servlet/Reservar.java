			...
			Establecimiento es=de.buscarEst(establecimiento);
				...
				for (int j = es.getHora_inicio(); j<= es.getHora_fin(); j++) {
					...
					for (int l = 1; l<= de.cantidadCanchas(establecimiento);l++) {
						// Aca esta el problema. Porque en realidad hay que copiar en disponibles, solamente las canchas que sean de ese tipo. Si por ejemplo, la cancha numero 2 y la 4 son de tipo 11, como hacer?
